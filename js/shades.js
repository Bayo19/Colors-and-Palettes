...
let shades = [red, orange, yellow, blue, cyan, green, gray, black, brown, magenta, purpleViolet, pink]

const root = document.querySelector('.shades-root')

shades.forEach(function(x) {
            root.innerHTML += `<div class="shade-name"><h3>${x[0]}</h3></div><div class= 'shade-color'>
${
